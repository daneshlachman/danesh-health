...
const hmStyles = StyleSheet.create({
  ...
  cell:         { flex: 1, margin: 2, borderRadius: 8, alignItems: 'center', justifyContent: 'center', minHeight: 52, backgroundColor: colors.gray[100] },
  selectedCell: { borderWidth: 2, borderColor: colors.gray[600] },
  cellDay:      { fontSize: 14, fontWeight: '700' },
  cellVal:      { fontSize: 9, fontWeight: '500', marginTop: 1 },
